...
let SimpleBarChart = () => {};
let containerWidth, containerHeight, margin, width, height, chart;

SimpleBarChart.prototype.init = (eleId, data) => {
  containerWidth = document.getElementById(eleId).parentElement.offsetWidth;
  containerHeight = document.getElementById(eleId).parentElement.offsetHeight;
  margin = {
    top: 80,
    right: 60,
    bottom: 30,
  ...
  const barWidth = (width / data.length) * 0.5; // 用于绘制每条柱
